...
import 'package:mobileapp/orderplacementpage1.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  Text('Charvi kurtis', style: TextStyle(fontSize: 16)),
                  Text( '₹557', style: TextStyle(fontSize: 16)),
            ...
            Padding(
              ...
              child: Text('Total Product Price: ₹557',
                style: TextStyle(fontSize: 14),
              ),
            ),
            SizedBox(height: 16),
